function nameGen(){
			...
			var rnd11a = parseInt(Math.floor(Math.random() * nm11.length));
			var rnd11b = parseInt(Math.floor(Math.random() * nm11.length));
			while(rnd11a === rnd11b){
				rnd11b = parseInt(Math.floor(Math.random() * nm11.length));
			}
			var rnd11c = parseInt(Math.floor(Math.random() * nm11.length));
			while(rnd11a === rnd11c || rnd11b === rnd11c){
				rnd11c = parseInt(Math.floor(Math.random() * nm11.length));
			}
			var rnd11d = parseInt(Math.floor(Math.random() * nm11.length));
			while(rnd11a === rnd11d || rnd11b === rnd11d || rnd11c === rnd11d){
				rnd11d = parseInt(Math.floor(Math.random() * nm11.length));
			}
			
			var rnd12a = parseInt(Math.floor(Math.random() * nm12.length));
			var rnd12b = parseInt(Math.floor(Math.random() * nm12.length));
			while(rnd12a === rnd12b){
				rnd12b = parseInt(Math.floor(Math.random() * nm12.length));
			}
			var rnd12c = parseInt(Math.floor(Math.random() * nm12.length));
			while(rnd12a === rnd12c || rnd12b === rnd12c){
				rnd12c = parseInt(Math.floor(Math.random() * nm12.length));
			}	
			...
			var rnd13c = parseInt(Math.floor(Math.random() * nm13.length));
			while(rnd13a === rnd13c || rnd13b === rnd13c){
				rnd13c = parseInt(Math.floor(Math.random() * nm13.length));
			}		
			...
			while(rnd16a === rnd16b){
				rnd16b = parseInt(Math.floor(Math.random() * nm16.length));
			}
			var rnd16c = parseInt(Math.floor(Math.random() * nm16.length));
			while(rnd16a === rnd16c || rnd16b === rnd16c){
				rnd16c = parseInt(Math.floor(Math.random() * nm16.length));
			}	
			var rnd17a = parseInt(Math.floor(Math.random() * nm17.length));
			var rnd17b = parseInt(Math.floor(Math.random() * nm17.length));
			var rnd18a = parseInt(Math.floor(Math.random() * nm18.length));
			var rnd18b = parseInt(Math.floor(Math.random() * nm18.length));
			var rnd18c = parseInt(Math.floor(Math.random() * nm18.length));
			var rnd18d = parseInt(Math.floor(Math.random() * nm18.length));
