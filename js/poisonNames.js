var nma = ["","","","","","","","b","c","d","f","g","h","k","l","m","n","p","r","s","t","v","w","x","z","bh","br","ch","cl","cr","dh","dr","fh","fl","fr","gh","gl","gr","kh","kl","kr","ph","pn","pr","rh","sc","sh","st","str","th","tr","vr"];
var nmb = ["a","e","i","o","u","a","e","i","o","u","a","e","i","o","u","a","e","i","o","u","a","e","i","o","u","a","e","i","o","u","y","y","y","ae","ai","ei","ia","ie","ee","eo"];
...
function nameGen(){
	...
	for(i = 0; i < 10; i++){
		if(i < 2){
			...
			rnd3 = Math.floor(Math.random() * nmd.length);
			if(i < 7){
				while(rnd < 7){
					rnd = Math.floor(Math.random() * nma.length);
				}
				...
				rnd4 = Math.floor(Math.random() * nmc.length);
				rnd5 = Math.floor(Math.random() * nmb.length);
