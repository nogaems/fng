...
var names9 = ["a","actum","actus","arbus","armus","aro","ashio","asi","asis","aris","ate","ecto","ectum","ectus","ego","egra","egris","elio","ello","em","empra","endio","endius","endo","enim","enis","enta","entus","enum","enus","eo","eom","eos","eous","erbus","ergio","erio","eris","erous","es","esco","eseo","etus","eum","eus","i","iate","iatis","iato","ictum","ictus","icum","icus","id","igeo","im","indo","inio","inius","io","ior","is","iseo","ite","iteus","itus","ium","ius","orgio","ori","orpus","ortia","ortis","ortus","orus","otis","otum","ucio","ucto","ula","ulsi","ulsis","ulso","ulus","um","undis","undo","uno","uro","us"];
var names10 = ["Anim","Anno","Annoy","Arach","Arachn","Arachni","Av","Avi","Ban","Bull","Can","Cand","Candel","Cani","Canin","Consi","Consil","Contag","Dem","Demo","Demon","Drac","Drag","Elem","Elemen","Element","Fel","Feli","Felin","Foc","Focu","Infec","Infect","Intim","Intimi","Intimid","Ligh","Light","Noct","Oppon","Oppres","Padl","Padloc","Perso","Person","Pest","Rasc","Rat","Serp","Serpen","Stri","Strix","Torch","Torm","Tormen","Tyr","Tyran","Vesper","Vex","Vexat","Vir","Viral","Ache","Ago","Agon","Miser"];
var names11 = ["Absol","Angel","Celest","Colos","Complet","Cor","Corrup","Dem","Demon","Demonic","Diab","Divin","Enorm","Ether","Gargant","Hid","Honor","Horrend","Horrib","Horrif","Immed","Immen","Immor","Impair","Imperf","Imperfec","Impur","Infec","Infect","Infer","Infern","Infin","Its","Juven","Limit","Malev","Minisc","Mix","Monst","Neth","Ordin","Perf","Perfec","Phan","Phant","Pris","Prist","Pur","Ref","Refin","Repeat","Repell","Satan","Spir","Spirit","Tain","Terrib","Thund","Total","Tremend","Vil","Virt","Virtu","Vulg"];
var br = "";
...
function nameGenHp(){
	...
	for(i = 0; i < 10; i++){
		...
		rnd[2] = Math.floor(Math.random() * names9.length);
		if(i < 3){
			rnd[3] = Math.floor(Math.random() * names10.length);
			names[i] = names8[rnd[0]] + names9[rnd[1]] + " " + names10[rnd[3]] + names9[rnd[2]];
		}else if(i < 6){
			rnd[3] = Math.floor(Math.random() * names11.length);
			names[i] = names8[rnd[0]] + names9[rnd[1]] + " " + names11[rnd[3]] + names9[rnd[2]];
		}else{
			names[i] = names8[rnd[0]] + names9[rnd[1]];
		}
