function nameGen(type){
	...
	var ns17 = ["they're a perfect match for his","they perfectly complement his","they make an ideal combination with his","they create a perfect balance with his"];
	var ns18 = ["a stylish","a lavish","an elegant","a classy","a modest","a sharp","a fancy","a chich","a handsome","a graceful"];
	var ns19 = ["brogue derbies","brogue monkstraps","brogue oxfords","cap toe balmorals","cap toe monkstraps","cap toe oxfords","fullstrap loafers","horsebit loafers","longwing bluchers","medallian cap toe oxfords","moc toe penny loafers","penny loafers","perf toe balmorals","plain toe bluchers","plain toe derbies","plain toe monkstraps","plain toe oxfords","shortwing bluchers","spectator oxfords","split toe bluchers","split toe derbies","wholecut oxfords"];
	var ns20 = ["an elegant","a stylish","a sleek","a trendy","a fancy","a luxurious","a graceful","a refined","a modest","a classic"];
	var ns21 = ["gloves","cuff links","a hat","a watch","a tie clip","a scarf","a brooch"];
	
	if(tp === 1){
		var rnd1 = parseInt(Math.floor(Math.random() * ns1.length));
		var rnd2 = parseInt(Math.floor(Math.random() * ns2.length));
		var rnd3 = parseInt(Math.floor(Math.random() * ns3.length));
		var rnd4 = parseInt(Math.floor(Math.random() * ns4.length));
		var rnd5 = parseInt(Math.floor(Math.random() * ns5.length));
		var rnd6 = parseInt(Math.floor(Math.random() * ns6.length));
		var rnd7 = parseInt(Math.floor(Math.random() * ns7.length));
		var rnd9 = parseInt(Math.floor(Math.random() * ns9.length));
		var rnd10 = parseInt(Math.floor(Math.random() * ns10.length));
		var rnd11 = parseInt(Math.floor(Math.random() * ns11.length));
		if(rnd10 === 1){
				while(rnd11 > 9){rnd11 = parseInt(Math.floor(Math.random() * ns11.length));
			}
		}
		var rnd12 = parseInt(Math.floor(Math.random() * ns12.length));
		var rnd13 = parseInt(Math.floor(Math.random() * ns13.length));
		var rnd14 = parseInt(Math.floor(Math.random() * ns14.length));
		var rnd15 = parseInt(Math.floor(Math.random() * ns15.length));
		var rnd16 = parseInt(Math.floor(Math.random() * ns16.length));
		var rnd17 = parseInt(Math.floor(Math.random() * ns17.length));
		var rnd18 = parseInt(Math.floor(Math.random() * ns18.length));
		var rnd19 = parseInt(Math.floor(Math.random() * ns19.length));
		var rnd20 = parseInt(Math.floor(Math.random() * ns20.length));
		var rnd21a = parseInt(Math.floor(Math.random() * ns21.length));
		var rnd21b = parseInt(Math.floor(Math.random() * ns21.length));
		while(rnd21a === rnd21b){
			rnd21b = parseInt(Math.floor(Math.random() * ns21.length));
		}
		...
		if(rnd6 < 4){
			while(rnd7 > 3){
				rnd7 = parseInt(Math.floor(Math.random() * nm7.length));
			}
		}else if(rnd6 < 8){
			while(rnd7 < 4 || rnd7 > 7){
				rnd7 = parseInt(Math.floor(Math.random() * nm7.length));
