...
function nameGen(){
	...
	for(i = 0; i < 10; i++){
		if(i < 3){
			...
			names = names6[rnd5] + " of " + names1[rnd0] + names2[rnd1] + names3[rnd2] + names4[rnd3] + names5[rnd4];
		}
