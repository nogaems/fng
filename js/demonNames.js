...
function nameGen(){
	...
	for(i = 0; i < 10; i++){
		if(i < 3){
			...
			names = nm1[rnd] + nm7[rnd2] + nm5[rnd3];
		}else if(i < 6){
			rnd = Math.floor(Math.random() * nm8.length);
			rnd2 = Math.floor(Math.random() * nm3.length);
			rnd3 = Math.floor(Math.random() * nm5.length);
			names = nm8[rnd] + nm3[rnd2] + nm5[rnd3];
		}else if(i < 8){
			rnd = Math.floor(Math.random() * nm6.length);
			rnd2 = Math.floor(Math.random() * nm4.length);
			rnd3 = Math.floor(Math.random() * nm5.length);
			rnd4 = Math.floor(Math.random() * nm7.length);
			names = nm6[rnd] + nm4[rnd2] + nm5[rnd3] + nm7[rnd4];
		}else{
			rnd = Math.floor(Math.random() * nm1.length);
			rnd2 = Math.floor(Math.random() * nm7.length);
			rnd3 = Math.floor(Math.random() * nm3.length);
			rnd4 = Math.floor(Math.random() * nm5.length);
			names = nm1[rnd] + nm7[rnd2] + nm3[rnd3] + nm5[rnd4];
		}
