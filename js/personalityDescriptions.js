var nm1 = ["A lot can be said of","Many things can be said of","There's a lot to say about","It takes a while to get to know","It's easy to get to know an open person like","A lot can be assumed when you first see","There's more than meets the eye in the case of","Looks can be deceiving when it comes","It's hard to describe a complex person like","Few know the true"];
var nm2 = ["above else know that","if nothing else you should know","at the very least","two things you'll never forget are that","the biggest two things to know are that","the two traits most people enjoy the most are that","perhaps most important is that","most know that above all else","if there's anything you should know it's that","at the very least you'll find out"];
var nm3 = ["those are often overshadowed by tendencies of","these are in a way balance by","they're often slightly tainted by a mindset of","they're less prominent and often intertwined with","they're far less prominent, especially compared to impulses of","in smaller doses and they're often spoiled by habits of","far less strongly and often mixed with","in a way they're lesser traits and tained by behaviors of","they're in shorter supply, especially considering they're mixed with","they're tainted by and mixed with habits of"];
var nm4 = ["most well-liked for","pretty much known for","pretty much loved for","often adored for","often admired for","kind of cherished for","most popular for","so well-liked for"];
var nm5 = ["People often","Friends usually","Friends tend to","Oftentimes people will","There are many times when friends","People regularly","Friends frequently","On many occasions people will"];
var nm6 = ["when they're feeling down","whenever they need cheering up","in times of need","whenever they need help","when they're in need of support","whenever they need assistance or help","especially when they need comforting or support"];
var nm7 = ["plenty of less favorable traits","a fair share of lesser days","plenty of rainy days","rotten moods and days","less pleasant traits","plenty of less favorable characteristics","a share of darker sides to deal with","plenty of lesser desired aspects","a range of flaws to deal with","plenty of character faults"];
var nm8 = ["tend to get in the way","aren't exactly fun to deal with","do cause plenty of friction","pose plenty of problems","sour the mood many a time","risk ruining pleasant moods","can cause things to heat up","don't make for the greatest company","cause plenty of grievances","are far from ideal"];
var nm9 = [", both personally and for others"," on often personal levels",", though more on a personal level than for others"," and reach all around",", much to the annoyance of others"," and could ruin plenty of evenings"," and just affect all around negatively"," even at the best of times"," and beyond what people are willing to deal with"," and make things uncomfortable to say the least"];
...
var nm12 = ["To make things worse","Never mind the fact","Let alone the fact","That's without even mentioning","To top it off","To make matters worse","As if that's not enough","There there's the fact","On top of that","That's without even stating"];
var nm13 = ["at least those are kept somewhat in check by habits of being","fortunately they're balanced out slightly by being","their effects are at least lessened by impulses of being","at the very least they're countered somewhat by being","their worst is softened by behaviors of being","in an odd way they're balanced by habits of being","at least they're not as bad due to intertwined habits of being","fortunately they're mixed with behaviors of being","they're not as prominent and counteracted by habits of being","at least they only show in smaller doses and mixed with behaviors of being"];
var nm14 = ["pretty much infamous","notorious","most disliked","pretty much hated","purposely avoided","almost feared","most condemned","loathed","often despised","often scorned"];
var nm15 = ["Plenty of days have been ruined","Multiple enemies have been made","Plenty of relationships came to a halt","Multiple nights have ended in disaster","Even careful encounters have been ruined","There's no sugar coating the effects caused","There's a great deal of pain left on all sides","Any healthy relationship is made incredibly difficult","Even the best intentions have been soured","There's not much meaningful that can be created"];
...
function nameGen(type){
	...
	if(tp === 1){
		...
		var name4 = "Unfortunately " + nm25[1] + " " + nm22[rnd12][1] + " " + nm20[rnd10] + ".";
	}else{
		...
		var rnd11 = parseInt(Math.floor(Math.random() * nm21.length));
		var rnd12 = parseInt(Math.floor(Math.random() * nm21.length));
		while(rnd11 === rnd12){
			rnd12 = parseInt(Math.floor(Math.random() * nm21.length));
		}
		var rnd13 = parseInt(Math.floor(Math.random() * nm21.length));
		while(rnd11 === rnd13 || rnd12 === rnd13){
			rnd13 = parseInt(Math.floor(Math.random() * nm21.length));
		}
		var rnd14 = parseInt(Math.floor(Math.random() * nm21.length));
		while(rnd11 === rnd14 || rnd12 === rnd14 || rnd13 === rnd14){
			rnd14 = parseInt(Math.floor(Math.random() * nm21.length));
		}
		var rnd15 = parseInt(Math.floor(Math.random() * nm21.length));
		while(rnd11 === rnd15 || rnd12 === rnd15 || rnd13 === rnd15 || rnd14 === rnd15){
			rnd15 = parseInt(Math.floor(Math.random() * nm21.length));
		}
		var rnd16 = parseInt(Math.floor(Math.random() * nm22.length));
		var rnd17 = parseInt(Math.floor(Math.random() * nm21.length));
		var rnd18 = parseInt(Math.floor(Math.random() * nm22.length));
		var rnd19 = parseInt(Math.floor(Math.random() * nm22.length));
		while(rnd18 === rnd19){
			rnd19 = parseInt(Math.floor(Math.random() * nm22.length));
		}
