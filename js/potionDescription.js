function nameGen(){
	...
	var rnd4c = parseInt(Math.floor(Math.random() * nm4.length));
	while(rnd4b === rnd4c || rnd4a === rnd4c){
		rnd4c = parseInt(Math.floor(Math.random() * nm4.length));
	}
	var rnd4d = parseInt(Math.floor(Math.random() * nm4.length));
	while(rnd4d === rnd4a || rnd4d === rnd4b || rnd4d === rnd4c){
		rnd4d = parseInt(Math.floor(Math.random() * nm4.length));
	}
	var rnd4e = parseInt(Math.floor(Math.random() * nm4.length));
	while(rnd4e === rnd4a || rnd4e === rnd4b || rnd4e === rnd4c || rnd4e === rnd4d){
		rnd4e = parseInt(Math.floor(Math.random() * nm4.length));
	}
	...
	var rnd5e = parseInt(Math.floor(Math.random() * nm5.length));
	while(rnd5e === rnd5a || rnd5e === rnd5b || rnd5e === rnd5c || rnd5e === rnd5d){
		rnd5e = parseInt(Math.floor(Math.random() * nm5.length));
	}
