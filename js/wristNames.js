...
function nameGen(type){
	...
	if(tp === 2){
		...
		names5 = ["Bracers","Armwraps","Bindings","Vambraces","Wristbands","Armguards","Cuffs","Wristwraps","Sleeves","Grasps"];
	}else{
