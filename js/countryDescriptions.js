function nameGen(){
			...
			var name2 = "Bordered between " + names5[random5] + " to the North, " + names5[random6] + " to the South, " + names5[random7] + " to the East and " + names5[random8] + " to the West, the country of " + names1[random1] + " mainly lives of " + names6[random9] + ", " + names6[random10] + " and " + names6[random11] + ".";
