...
var.put('nm1', Js([Js('br'), Js('c'), Js('cr'), Js('dr'), Js('f'), Js('g'), Js('gr'), Js('j'), Js('k'), Js('kr'), Js('m'), Js('n'), Js('p'), Js('pr'), Js('q'), Js('qr'), Js('r'), Js('t'), Js('z')]))
var.put('nm2', Js([Js('a'), Js('e'), Js('i'), Js('o'), Js('u'), Js('a'), Js('e'), Js('i'), Js('o'), Js('u'), Js('a'), Js('e'), Js('i'), Js('o'), Js('u'), Js('a'), Js('e'), Js('i'), Js('o'), Js('u'), Js('a'), Js('e'), Js('i'), Js('o'), Js('u'), Js('y'), Js('y'), Js('ou'), Js('au'), Js('ei')]))
var.put('nm3', Js([Js('c'), Js('cc'), Js('cd'), Js('cb'), Js('g'), Js('gg'), Js('gt'), Js('gb'), Js('gd'), Js('k'), Js('kk'), Js('kh'), Js('kt'), Js('mb'), Js('mk'), Js('mq'), Js('nq'), Js('nk'), Js('ng'), Js('q'), Js('qh'), Js('r'), Js('rr'), Js('rq'), Js('rk'), Js('th'), Js('w')]))
var.put('nm4', Js([Js(''), Js('m'), Js('n'), Js('r'), Js('s'), Js('th')]))
var.put('nm5', Js([Js(''), Js(''), Js(''), Js('d'), Js('f'), Js('g'), Js('h'), Js('j'), Js('k'), Js('l'), Js('m'), Js('n'), Js('p'), Js('r'), Js('s'), Js('t'), Js('v'), Js('z')]))
var.put('nm6', Js([Js('a'), Js('e'), Js('i'), Js('o'), Js('u')]))
var.put('nm7', Js([Js('f'), Js('ff'), Js('l'), Js('ly'), Js('lh'), Js('ls'), Js('lr'), Js('lm'), Js('ln'), Js('m'), Js('my'), Js('mh'), Js('n'), Js('ny'), Js('nh'), Js('ph'), Js('phr'), Js('r'), Js('rr'), Js('ry'), Js('rh'), Js('sy'), Js('sh'), Js('sr'), Js('sl'), Js('th'), Js('ty'), Js('y')]))
var.put('nm8', Js([Js(''), Js(''), Js(''), Js(''), Js(''), Js(''), Js(''), Js(''), Js(''), Js(''), Js('h'), Js('s')]))
pass
pass


# Add lib to the module scope
pathfinderCatfolk = var.to_python()